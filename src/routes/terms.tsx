    ...
    <div className="mx-auto max-w-3xl px-6 py-20 md:py-24">
      ...
      <div className="mt-10 space-y-6 text-sm leading-relaxed text-muted-foreground md:text-base">
        ...
        <section>
          ...
          <p className="mt-2">All content on this site, including text, graphics, logos, frameworks, and methodologies, is the property of Business Movers or its licensors, and may not be reproduced or redistributed without written permission.</p>
        </section>
